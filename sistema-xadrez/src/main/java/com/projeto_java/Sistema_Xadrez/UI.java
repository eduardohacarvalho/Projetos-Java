...
public class UI {
    ...
    public static void printMatch (ChessMatch chessMatch, List<ChessPiece> captured){
        ...
        if (chessMatch.getCheck()){
            System.out.println("O Rei está em cheque!");
        }
    }
    ...
    private static void printCapturedPieces(List<ChessPiece> captured){
        List<ChessPiece> white = captured.stream().filter(x -> x.getColor() == ChessColor.WHITE).collect(Collectors.toList());
        List<ChessPiece> black = captured.stream().filter(x -> x.getColor() == ChessColor.BLACK).collect(Collectors.toList());
